            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-sm-6 map-wrapper">
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1944.8436223308872!2d74.83612014018027!3d12.863465831176798!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba35bad3d17b75b%3A0x641a738670ab308c!2sMangalore%20Private%20Bus%20Stand!5e0!3m2!1sen!2sin!4v1609253034244!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>       
                    </div>
...
if (isset($_POST['send'])) 
{
        ...
        $query=mysqli_query($con,"INSERT INTO `contact`(`name`, `email`, `subject`, `msg`) VALUES ('$name','$email','$subject','$msg')") or die(mysqli_error($con));
            if ($query==true) 
            {
