...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $insert = "INSERT INTO bangales(name,price, shop,image) VALUES('$product_name', '$product_price', '$shop_name','$product_image')";
...
if(isset($_GET['delete'])){
   $Bid = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM bangales WHERE Bid = $Bid");
   header('location: Bracelets&Bangales.php');
};
...
$select = mysqli_query($conn, "SELECT * FROM bangales");
...
<div class="product-display">
   <table class="product-display-table">
      ...
      <tr>
         ...
         <td>
            <a href="Bracelets&Bangales.php?delete=<?php echo $row['Bid']; ?>" class="btn" onclick="return confirm('Are you sure to delete it?'); "><i class="fas fa-trash"></i> delete </a>
         </td>
         <!-- <td><a href="del_package.php?p_id=<?php echo $row['Bid'];?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure to delete it?'); "><i class="fas fa-trash"></i></a></td> -->
      </tr>
   <?php } ?>
   </table>
</div>
