...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $insert = "INSERT INTO earrings(name,price,shop,image) VALUES('$product_name', '$product_price', '$shop_name','$product_image')";
...
if(isset($_GET['delete'])){
   $Eid = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM earrings WHERE Eid = $Eid");
...
$select = mysqli_query($conn, "SELECT * FROM earrings");
...
<div class="product-display">
   <table class="product-display-table">
      ...
      <tr>
         ...
         <td>
            <a href="Earrings.php?delete=<?php echo $row['Eid']; ?>" class="btn" onclick="return confirm('Are you sure to delete it?'); "><i class="fas fa-trash"></i> delete </a>
         </td>
         <!-- <td><a href="del_package.php?p_id=<?php echo $row['Eid'];?>" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure to delete it?'); "><i class="fas fa-trash"></i></a></td> -->
      </tr>
   <?php } ?>
   </table>
</div>
