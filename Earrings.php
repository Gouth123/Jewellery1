...
<body>
    ...
    <main>
		...
		<div class="container">
            <div class="row mt-4">
			<?php
				$query = "SELECT * FROM earrings ORDER BY Eid ASC";
				...
				?>
			<div class="col-md-4">
				<form method="post" action="cart.php?action=add&id=<?php echo $row["Eid"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
                    <img src="pic/earings/<?php echo $row["image"]; ?>" class="img-responsive" /><br />
